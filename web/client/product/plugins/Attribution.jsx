...
import src from '../assets/img/RSE-logo.jpg';
    ...
    AttributionPlugin: assign(Attribution, {
        NavMenu: {
            tool: (props) => ({
                ...
                img: props.src && <img className="customer-logo" src={props.src} height="45" /> || <img className="customer-logo" src={src} height="45" />,
                logo: true
            })
        }
    })
